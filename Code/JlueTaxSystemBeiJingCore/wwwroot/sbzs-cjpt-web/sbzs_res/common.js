...
function getMrjmseBySsjmxzInZzsyjsb(jmzlxDm,jsyj,bqynse,fdsl,jmfd,jmed,jmsl,jmxzDm,zspmDm){
 ...
 function calculate_gs_jsme_sl_sskcs(){
	 ...
	 var zszmDm = arguments[14]; //核定应纳税额
	...
	if (zspmDm == '101060200' || zspmDm == '101060300') {
		...
		if (formData.dqdehfyhzsbxxGridlbVO) {		// 分月汇总
			...
			return dqdeCalc2019Gs(rtnType, srze, yssdl, zspmDm, jsbz, sjjyyf, hdjsyj, nsqxDm, zsl, sqq, sqz, kyrq, tbrq, 'dqde', hdynse,zszmDm);
		}
	}
 ...
 * type: dqde|fyhz
 */
function dqdeCalc2019Gs(rtnType, ysx, yssdl, zspmDm, jsbz, sjjyyf, hdjsyj, nsqxDm, sl, sqq, sqz, kyrq, tbrq, type, hdynse,zszmDm) {
