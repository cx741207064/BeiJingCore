...
<head>
    ...
    function loadPage(){
        ...
        document.getElementById("iframehtm").src = href + "/setting/cwbbydy.html" ;
        loadCssAndJs();
    }
    function initFrame(){
	...
	$(document).ready(function(e) {
		...
		if('QYSDSJMANDJCSZ'.indexOf('CWBBYDY'.toUpperCase())!=-1){
			$('.anima').css('display','');	
    	}else{
    		$('.anima').css('display','none');	
    	}
		if('11101090000'.indexOf('137')==0 && 'CWBBYDY'.toUpperCase().indexOf('CWBB')==0){
			$("#hqjdsj").hide();
			$("#cwbbchssj").show();
...
<input type="hidden" id="bzz" value="dzswj"></input>
<input type="hidden" id="ywbm" value="CWBBYDY"></input>
<input type="hidden" id="swjgDm" value="11101090000"></input>
<input type="hidden" id="djxh" value="10111101000049968154"></input>
<input type="hidden" id="sssqQ" value="2019-04-01"></input>
...
<input type="hidden" id="kjzdzzDm" value="101"></input>
<input type="hidden" id="isycs" value=""></input>
<input type="hidden" id="cusId" value=""></input>
<input type="hidden" id="bbbsqDm" value="3"></input>
<input type="hidden" id="zlbsxlDm" value="ZL1001001"></input>
...
<table width="100%" height="60" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="right">
			...
			<a id="save" href="#" class="btn btn06">下一步</a> 
