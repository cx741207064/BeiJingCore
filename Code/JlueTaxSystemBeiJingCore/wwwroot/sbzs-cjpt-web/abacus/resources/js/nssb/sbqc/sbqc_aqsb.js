 ...
 */
function sbinit(url,sbqx,ssqq,ssqz,gdslxDm,zsxmDm,nsqxDm,yzpzzlDm,sbyfIn){
        ...
        $.ajax({
            ...
            success : function(data) {
                ...
                if ("N" == sfkyqsbbz) {
                    ...
                    sbinit2(url,sbqx,ssqq,ssqz,gdslxDm,zsxmDm,nsqxDm,yzpzzlDm,sbyfIn);
                }
...
/**
  *打开申报表
  */
function sbinit2(url,sbqx,skssqQ,skssqZ,gdslxDm,zsxmDm,nsqxDm,yzpzzlDm,sbyfIn){
	//从url里获取申报业务编码
	var sbywbm = "";
