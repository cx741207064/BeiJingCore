...
function getsbzfmx(sbqdzf, sbfsDm, pzxh, gdslxDm, skssqq, skssqz, sbrq, yzpzzlDm, zsxmDm) {
    ...
    if (yzpzzlDm != "BDA0610994") {
        var zxurl = "/sbzs-cjpt-web/nssb/jySbgzOrzf.do?zxbz=" + zxbz + "&jkly=SBZF&skssqq=" + skssqq + "&skssqz=" + skssqz + "&yzpzxh=" + pzxh + "&yzpzzlDm=" + yzpzzlDm + "&gdslxDm=" + gdslxDm + "&zsxmDm=" + zsxmDm;
        zxzfpd(zxurl);
        if (!zxpd) {
            return;
        } else {
    ...
    if ((bool_chkSingleQx && single) || (yzpzzlDm == "BDA0610994")) {
        //alert("按次申报跳过逾期校验");
